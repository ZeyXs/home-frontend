// My custom implementation of a Typewriter hook originally made by https://github.com/awran5/react-simple-typewriter.

import { useCallback, useEffect, useRef, useReducer } from 'react';
import { reducer } from '@/utils/typewriter/reducer';
...
export type TypewriterProps = {
  ...
  onDelay?: () => void;
  /** Callback Function that is triggered when deleting is finished */
